...
<div class="h-screen absolute inset-0 flex flex-col gap-8 justify-center items-center">
  ...
  <div class="flex gap-6">
    ...
    <a href="mailto:mail@kleidi.ca" target="_blank" rel="noopener" title="Email" class="link"><MailIcon size="32" /></a>
    <a href="https://github.com/kbzt" target="_blank" rel="noopener external" title="Github" class="link"><GithubIcon size="32" /></a>
    <a href="https://linkedin.com/in/kleidib/" target="_blank" rel="noopener external" title="Linkedin" class="link"><LinkedinIcon size="32" /></a>
  </div>
